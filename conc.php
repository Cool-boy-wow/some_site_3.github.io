...
<br>
<h1 class="FVGCQ">Terms & Conditions</h1>
...
<h5>PLEASE READ THESE TERMS AND CONDITIONS CAREFULLY. BY CLICKING THE "CREATE ACCOUNT" BUTTON OR BY ACCESSING OR USING THE SERVICES, YOU AGREE TO BE LEGALLY BOUND BY THESE TERMS AND CONDITIONS AND ALL TERMS INCORPORATED BY REFERENCE.</h5>
<text>This summary of our Terms and Conditions offers you an overview of the key terms that apply to your use of our website and trading services. While we hope this summary section is helpful, you should read the complete Terms and Conditions of Service below since they provide important information about how our services work. Please note that we refer to our online service where you can execute trades as "Bitxbtc".</text>
...
<text>Bitxbtc provides you with a simple and convenient way to trade one type of digital asset for another type of digital asset. Our services do not provide users with the ability to trade one form of legal tender for another form of legal tender. Additionally, the range of services available to you will depend in part upon the countries from which you access Bitxbtc.</text>

<br>


<br>
<h4>Eligibility and Acceptable Use</h4>

<text>You must meet certain eligibility criteria to use Bitxbtc. For instance, you must be an adult and there are certain locations from which you may not be able to use some or all of Bitxbtc. Additionally, there are certain things you cannot do when using Bitxbtc, such as engage in illegal activities, lie, or do anything that would cause damage to our services or systems. Please see the acceptable use section for more details.</text>
<br><br><br>
<h4>Trading Risks</h4>
<text>Engaging in any trade can be financially risky, and there can be higher financial risks if you engage in any margin transactions, use any other sophisticated trading options, or trade in digital assets that are subject to volatile market price movements. Please don't use Bitxbtc if you do not understand these risks and enter into trades only when you understand the trading option you are using, the characteristics of the digital asset you intend to trade, and the potential financial risk of loss trading them entails.
</text>
<br><br>
<br>
<h4>Other Important Legal Terms</h4>
<text>There are important legal terms provided below in the complete Terms and Conditions, including your indemnification responsibilities, our limitation of liability and warranty disclaimers, and your agreement to arbitrate most disputes. Please take the time to read these terms carefully. You can always contact us through support if you have any questions at support@bitxbtc.org
</text>
<br><br>
