...
<link href="https://fonts.googleapis.com/css2?family=Roboto:wght@100;400&display=swap" rel="stylesheet">
	...
	<meta charset="utf-8">
	<title>Internal addresses</title>
...
<br>
<h1 class="FVGCQ">Internal addresses</h1>
...
<div class="container">
  <div class="row">
    <div class="col-sm-4">
      <div class="container VQOZ">
        <br>
        <h4 class="DDD">BTC Address</h4>
        <div class="container ASDF" > 
        </div>
        <br>
        <form>
            <label><text class="RRR">Address</text><input type="text" name="adres" class="ZZZ"></label><br>
            <label><text class="RRR">Amount</text><input type="text" name="adres" class="ZZZ"></label>
            <input type="submit" name="Send_1" class="but_5 HHH">
        </form>

      </div>
    </div>
    <div class="col-sm-4"><div class="container VQOZ">
      <br>
        <h4 class="DDD">ETH Address</h4>
        <div class="container ASDF" > 
        </div>
        <br>
        <form>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-4"><div class="container VQOZ">
      <br>
        <h4 class="DDD">TRX/USDT Address</h4>
        <div class="container ASDF" > 
        </div>
        <br>
        <form>
