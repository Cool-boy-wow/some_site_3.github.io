...
<h4>Choose Quick Amount to Deposit</h4>
...
<br>
<input type="text" name="dep" placeholder="0.0 USD">

<p id="G6">Note: Minimum deposit amount is 150 USD</p>
 <div class="container ASDF" > 
</div>
<br>
 <div class="checkbox">
      <input type="checkbox" id="click">
      <label for="click" class="text">I accept <a href="conc.php" class="NNN">Terms and Conditions</a></label>
    </div>
<input type="button" name="depo" class="but_144" value="Confirm & proceed">
